...
- Use fake data simulations to illustrate a trade off between confounders and type M error
...
## The trade-off we are trying to illustrate
...
- **DiD/event study**: limits variation in x by considering only a small number of events and limit data to observations close to the treatment date

---

## What we did (or are finishing)

- Build fake data simulations: replicate example from a different econ field for each method

- Discuss "solutions": how do researchers address the issue we underline?

 - Run simulations
 - Run robustness retrodesign calculations
