...
After generating the data, we can run an estimation. We want to be able to compute the estimation for different 

```{r estimate_panoptic}
estimate_panoptic <- function(data, n_clusters) {
  n_clusters <- ifelse(missing(n_clusters), nrow(data), n_clusters)
