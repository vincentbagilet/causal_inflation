...
summary_sim_p_treat <- summarise_simulations(sim_p_treat)
```
...
fixed_param <- baseline_param_panoptic
vect_n_clusters <- seq(50, 500, 50)
n_iter <- 100
...
summary_sim_clusters <- summarise_simulations(sim_clusters)
