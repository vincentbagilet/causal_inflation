...
Here is an example of the data created through this process:

```{r example_data, echo=FALSE}
generate_data_rdd(N = 10) %>% 
  kable()
```
...
```{r}
compute_simulation_rdd <- function(N = 1000, 
                              sigma_u = 0.5,
                              mu_h = 75, 
                              sigma_h = 7, 
                              sigma_e = 4, 
