...
sim_rdd %>% 
  ...
  ggridges::geom_density_ridges(
    aes(x = estimate, y = factor(bw), fill = significant, color = significant), 
    # stat = "binline",
    draw_baseline = FALSE, bins = 50, alpha = 0.6
  ) +
  coord_flip()
...
sim_rdd %>% 
  ...
  geom_histogram(bins = 45, alpha = 0.8) +
  ...
  labs(
    y = "Bandwidth size", 
    x = expression(paste("Average  ", frac("Estimate", "True Effect"))),
    fill = "Estimate",
    title = "Distribution of estimates for different bandwidth",
