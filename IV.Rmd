...
```{r exploration_results_IV, echo=FALSE, fig.asp=1}
...
simulations_IV %>% 
  ...
  labs(
    ...
    subtitle = paste(
      ...
      .data$iv_strength, 
      "and OVB intensity = ", 
      unique(.data$ovb_intensity), ")"
    ),
    x = "Estimate of the treatement effect",
    y = "Count",
    fill = "Estimate significant",
...
```{r graph_results_IV, echo=FALSE, fig.asp=0.8}
...
```{r graph_results_all_IV, echo=FALSE, fig.asp=0.8}
summary_simulations_IV %>% 
  mutate(
    ovb_intensity_name = paste("OVB intensity:", ovb_intensity)
  ) %>%
