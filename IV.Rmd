...
ggsave("main_graph_IV_paper.pdf", path = "images", width = 7.4, height = 4.4)
```
...
#     exag_ratio = median(ifelse(significant, abs(estimate/true_effect), NA), na.rm = TRUE)
#   ) %>% 
#   ggplot(aes(x = iv_strength, y = mean_fstat, color = exag_ratio)) +
#   geom_point() +
#   # geom_jitter(alpha = 0.5) +
#   labs(
#     title = "A correlation between IV strength and F-statistic",
