...
generate_data_IV <- function(N = 1000,
                             ...
                             alpha_y = 0,
                             alpha_x = 0,
                             treatment_effect = 1, #treatment effect
                             iv_strength = 0.3, #IV strength
                             ovb_intensity = 2 #OVB intensity
                             ) {
...
param_IV <- crossing(vect_iv_strength, vect_ovb_intensity) %>% 
...
simulations_IV %>% 
  ...
  labs(
    title = "Distribution of the estimates of the treatement effect",
    subtitle = "For differentd models",
    color = "",
    fill = "",
    x = "Estimate of the treatement effect",
    y = "Density",
